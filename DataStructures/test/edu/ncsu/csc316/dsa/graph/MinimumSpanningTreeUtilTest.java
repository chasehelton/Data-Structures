...
/**
 * Tests the MinimumSpanningTreeUtil class.
 * @author Chase Helton
 *
 */
public class MinimumSpanningTreeUtilTest {
    ...
    public void testPrimJarnik() {
    	...
    	PositionalList<Edge<Highway>> primJarnik = MinimumSpanningTreeUtil.primJarnik(undirectedGraph);
    	
    	assertFalse(primJarnik.isEmpty());
    	
    	PositionalList<Edge<Highway>> kruskal = MinimumSpanningTreeUtil.kruskal(undirectedGraph);
    	
    	assertFalse(kruskal.isEmpty());
    }
